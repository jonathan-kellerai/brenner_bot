...
function ArchiveBoxIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 6.375v12.75A2.625 2.625 0 0117.625 21.75H6.375A2.625 2.625 0 013.75 19.125V6.375m16.5 0A2.625 2.625 0 0017.625 3.75H6.375A2.625 2.625 0 003.75 6.375m16.5 0v.375A2.625 2.625 0 0117.625 9.375H6.375A2.625 2.625 0 013.75 6.75v-.375" />
...
function ArrowUturnLeftIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 15l-3-3m0 0l3-3m-3 3h10.5a3.75 3.75 0 010 7.5H12" />
    </svg>
  );
}
